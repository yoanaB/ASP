    ...
    <div>
            <center><h1><font color="white" > Попълване на данните за XML документа </font></h1>
                <p>
                    ...
                    <center><font color="maroon">ДАННИ ЗА ПОРОДАТА КЪМ FCI</font></center>
                <center><table border="1">
                <tr>
               <td><asp:Label ID="Label1" runat="server">*Номер на стандарта:</asp:Label></td><td><asp:TextBox
               ...
               <tr>
               <td><asp:Label ID="Label35" runat="server" >Характеристика на групата:</asp:Label></td><td><asp:TextBox
               ID="groupDescrInput" runat="server" TextMode="MultiLine" 
                       autocomplete="off"></asp:TextBox></td>
               </tr>
                
                <tr>
                <td><asp:Label ID="Label5" runat="server" >*Секция в която попада породата:</asp:Label></td>
                  <td>  <asp:TextBox
            ...
            <tr>
            <td>
               <asp:Label ID="Label36" runat="server" >Характеристика на секцията:</asp:Label></td><td><asp:TextBox
            ...
            <td><asp:Label ID="Label12" runat="server" >Часова зона на държавата основателка:</asp:Label></td><td><asp:DropDownList
               ...
               <center><table border ="1">
               <tr>
               <td><asp:Label ID="Label18" runat="server" >Форма на главата на кучето:</asp:Label></td>
                   <td><asp:TextBox
               ...
               <tr>
               <td><asp:Label ID="Label19" runat="server" >Зъбна формула на кучето:</asp:Label></td>
                   <td><asp:TextBox
               ID="teethInput" runat="server" Height="59px" TextMode="MultiLine" Width="251px" 
                       autocomplete="off"></asp:TextBox></td>
               </tr>
               
               <tr>
               <td><asp:Label ID="Label20" runat="server" >Форма на ушите на кучето:</asp:Label></td>
                   <td><asp:TextBox
               ...
               <tr>
               <td><asp:Label ID="Label21" runat="server" >Форма на очите на кучето:</asp:Label></td>
                  <td> <asp:TextBox
               ...
               <tr>
               <td><asp:Label ID="Label22" runat="server" >Форма на опашката на кучето:</asp:Label></td>
                   <td><asp:TextBox
               ...
               ID="preferedColorInput" runat="server" Height="22px" TextMode="SingleLine" 
                ...
                <tr>
                <td><asp:Label ID="Label27" runat="server" >Космена покривка на кучето:</asp:Label></td>
                   <td><asp:TextBox
               ID="furInput" runat="server" Height="59px" TextMode="MultiLine" Width="251px" 
                ...
                <tr><td><asp:Label ID="Label30" runat="server" Text="Label">Размери и тегло при тази порода:</asp:Label></td></tr>
                <tr>
                <td><asp:Label ID="Label31" runat="server" Text="Label">Височина при мъжките(измеренеа в холката):</asp:Label></td><td><asp:TextBox ID="malesSizeInput" runat="server" autocomplete="off"></asp:TextBox></asp:Label></td>
                </tr>
                

                <tr> 
                 
                 <td><asp:Label ID="Label32" runat="server" Text="Label">Височина при женските(измеренеа в холката):</asp:Label></td><td><asp:TextBox ID="femalesSizeInput" runat="server" autocomplete="off"></asp:TextBox></asp:Label></td>

                </tr>

                <tr>
                <td><asp:Label ID="Label33" runat="server" Text="Label" >Килограми при мъжките екземпляри:</asp:Label></td><td><asp:TextBox ID="malesWeightInput" runat="server" autocomplete="off"></asp:TextBox></asp:Label></td>
                </tr>

                <tr> 
                <td><asp:Label ID="Label34" runat="server" Text="Label">Килограми при женските екземпляри:</asp:Label></td><td><asp:TextBox ID="femalesWeightInput" runat="server" autocomplete="off"></asp:TextBox></asp:Label></td>
                </tr>
                </table></center>
