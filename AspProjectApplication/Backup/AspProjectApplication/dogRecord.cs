...
namespace AspProjectApplication
{
    public class dogRecord
    {
        ...
        private string _malesWeight;
        private string _femalesWeight;
        ...
        public string females_weight
        {
            get
            {
                return _femalesWeight;
            }
            set
            {
                _femalesWeight = value;
            }
        }
        ...
        public dogRecord(string aSnumber, string aGroup, string aSection, string aGroupDescr, string aSectionDescr, string aBreedName, string aCountryCode, string aCapital,
            string aOfficialLanguage, string aTimeZone, string aCurrency, string aCountryName, string aCountryContinent, string aGovernmentType, int aYearEst, string aHead,
            string aTeeth, string aEars, string aEyes, string aTail, string aPrimaryColor, string aSecondaryCol, string aPreferedCol, string aFur, string aImage, string aMalesSize,
            string aFemalesSize, string aMalesWeight, string aFemalesWeight)
        {
            ...
            males_weight = aMalesWeight;
            females_weight = aFemalesWeight;
        }

        public dogRecord() : this("","","","","","","","","","","","","","",0,"","","","","","","","","","","","","","") { }
