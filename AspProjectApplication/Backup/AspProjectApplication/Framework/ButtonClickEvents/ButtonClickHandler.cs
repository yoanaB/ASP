...
namespace AspProjectApplication.Framework.ButtonClickEvents
{
    public static class ButtonClickHandler
    {
        public static void SubmitXmlButtonWithSuccessfulValidation( Label snStatusLabel,Label groupStatusLabel,Label sectionStatusLabel,
                                                                    ...
                                                                    TextBox govTypeInput,TextBox yearEstInput,TextBox headFrmInput,TextBox teethFormInput,
                                                                    ...
                                                                    TextBox mWeghtInput,TextBox fWeghtInput,Label sbmtResLabel,TextBox errTextBox)
        {
            ...
            if (!RecordsCheckAndValidation.IsThereSuchAStandartNumber(snInput.Text))
            {
                ...
                var myDogRec = new dogRecord(snInput.Text, grInput.Text, secInput.Text,
                                             ...
                                             yearEstInput.Text != string.Empty
                                                 ...
                                                 : 0, headFrmInput.Text, teethFormInput.Text, earsFormInput.Text, eyesFormInput.Text,
                                             tailFormInput.Text, primColInput.Text, secColInput.Text,
                                             prefColInput.Text, furFormInput.Text, imgInput.Text, mSizeInput.Text,
                                             fSizeInput.Text, mWeghtInput.Text, fWeghtInput.Text);

                InsertDogBreedRecord.InsertAdogRecordIntoTheDataBase(myDogRec, errTextBox );

                //След това създаваме XML документ, валиден за посоченото DTD и го попълваме с въведените данни
                InsertDogBreedRecord.CreateValidXmlDocument(snInput,grInput,secInput,brNameInput,cntrCapInput,
                                                            offLangInput,tZoneInput,currInput,cntryCodeInput,
                                                            cntrNameInput,cntryContinentInput,govTypeInput,
                                                            yearEstInput,headFrmInput,teethFormInput,earsFormInput,
                                                            eyesFormInput,tailFormInput,primColInput,secColInput,
                                                            prefColInput,furFormInput,imgInput,mSizeInput,fSizeInput,
                                                            mWeghtInput,fWeghtInput,secDescrInput,grDescrInput);
            }
            else
            {
                sbmtResLabel.Text =
